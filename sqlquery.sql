...
VALUES 
(1, '123-456789-011', 1000, '2024-01-01', '2024-06-30', ROUND(1000 * POWER(1 + 0.002292, 6) - 1000, 2)),  -- 6 months
(1, '123-456789-011', 1100, '2024-07-01', '2024-12-31', ROUND(1100 * POWER(1 + 0.002292, 6) - 1100, 2)),
(1, '123-456789-011', 1200, '2025-01-01', '2025-06-30', ROUND(1200 * POWER(1 + 0.002292, 6) - 1200, 2)),
(1, '123-456789-011', 1300, '2025-07-01', '2025-12-31', ROUND(1300 * POWER(1 + 0.002292, 6) - 1300, 2)),
(2, '124-987654-012', 1000, '2024-01-01', '2024-06-30', ROUND(1000 * POWER(1 + 0.002292, 6) - 1000, 2)),
(2, '124-987654-012', 1050, '2024-07-01', '2024-12-31', ROUND(1050 * POWER(1 + 0.002292, 6) - 1050, 2)),
(2, '124-987654-012', 1150, '2025-01-01', '2025-06-30', ROUND(1150 * POWER(1 + 0.002292, 6) - 1150, 2)),
(2, '124-987654-012', 1250, '2025-07-01', '2025-12-31', ROUND(1250 * POWER(1 + 0.002292, 6) - 1250, 2)),
(3, '125-123456-014', 1000, '2024-01-01', '2024-06-30', ROUND(1000 * POWER(1 + 0.002292, 6) - 1000, 2)),
(3, '125-123456-014', 1100, '2024-07-01', '2024-12-31', ROUND(1100 * POWER(1 + 0.002292, 6) - 1100, 2)),
(3, '125-123456-014', 1150, '2025-01-01', '2025-06-30', ROUND(1150 * POWER(1 + 0.002292, 6) - 1150, 2)),
(3, '125-123456-014', 1300, '2025-07-01', '2025-12-31', ROUND(1300 * POWER(1 + 0.002292, 6) - 1300, 2)),
(4, '126-789456-013', 1000, '2024-01-01', '2024-06-30', ROUND(1000 * POWER(1 + 0.002292, 6) - 1000, 2)),
(4, '126-789456-013', 1050, '2024-07-01', '2024-12-31', ROUND(1050 * POWER(1 + 0.002292, 6) - 1050, 2)),
(4, '126-789456-013', 1100, '2025-01-01', '2025-06-30', ROUND(1100 * POWER(1 + 0.002292, 6) - 1100, 2)),
(4, '126-789456-013', 1150, '2025-07-01', '2025-12-31', ROUND(1150 * POWER(1 + 0.002292, 6) - 1150, 2)),
(5, '127-654321-015', 1000, '2024-01-01', '2024-06-30', ROUND(1000 * POWER(1 + 0.002292, 6) - 1000, 2)),
(5, '127-654321-015', 1100, '2024-07-01', '2024-12-31', ROUND(1100 * POWER(1 + 0.002292, 6) - 1100, 2)),
(5, '127-654321-015', 1200, '2025-01-01', '2025-06-30', ROUND(1200 * POWER(1 + 0.002292, 6) - 1200, 2)),
(5, '127-654321-015', 1300, '2025-07-01', '2025-12-31', ROUND(1300 * POWER(1 + 0.002292, 6) - 1300, 2));